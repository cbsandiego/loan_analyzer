...
# YOUR CODE HERE!
print(f"The total sum of all loans: {total_sum_loans}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
average_loan_price = total_sum_loans/total_number_of_loans
...
# Print each variable.
# YOUR CODE HERE!
print("The future value is: " + str(loan.get("future_value")))
print("The remaining months are: " + str(loan.get("remaining_months")))
...
# YOUR CODE HERE!
present_value = loan.get("future_value")/(1 + .2/12) **9
...
if present_value >= loan.get("loan_price"):
    print("Buy! The loan is worth the cost to purchase!")
else:
    print("DO NOT BUY! It's too expensive and not worth the price!")
